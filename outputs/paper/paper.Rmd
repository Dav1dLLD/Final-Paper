...
```{r,fig.height = 3, fig.width = 5,fig.cap="Barplot of whether respodent smokes or not according to gender", include=TRUE, echo=FALSE,message=FALSE,warning=FALSE}
...
```{r,fig.height = 3, fig.width = 5,fig.cap="Barplot of whether respodent smokes or not according to ethnicity", include=TRUE, echo=FALSE,message=FALSE,warning=FALSE}
...
```{r,fig.height = 3, fig.width = 5,fig.cap="Barplot of whether respodent smokes or not according to marital status", include=TRUE, echo=FALSE,message=FALSE,warning=FALSE}
...
```{r,fig.height = 3, fig.width = 8,fig.cap="Barplot of whether respodent smokes or not according to region", include=TRUE, echo=FALSE,message=FALSE,warning=FALSE}
